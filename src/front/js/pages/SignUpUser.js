                ...
                <div className="p-5 form-wrapper">
                    ...
                    <div className="d-flex flex-row align-items-center justify-content-center">
                        <div className="w-100">
                            ...
                            <div className="form-group mt-3">
                                <input type={shown ? 'text' : 'password'} required={true} maxLength="12" minLength="6" className="form-control inputIsRelative" placeholder="Password" onChange={(e) => { setPassword(e.target.value); this.onChange }} value={password} />
